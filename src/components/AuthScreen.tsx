  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black p-4 text-white">
      <div className="w-full max-w-sm rounded-3xl border border-neutral-800 bg-[#0b0f14] p-5 shadow-2xl">
        <div className="mb-5">
          <div className="text-sm font-bold tracking-wide">Poker App Nico</div>
        ...
        <div className="space-y-3">
          <div className="rounded-xl border border-neutral-700 bg-black/25 p-2">
            <div className="text-[10px] uppercase tracking-[0.22em] text-neutral-400">Email</div>
            <input
              value={email}
          ...
          <div className="rounded-xl border border-neutral-700 bg-black/25 p-2">
            <div className="text-[10px] uppercase tracking-[0.22em] text-neutral-400">Contraseña</div>
            <input
              value={password}
